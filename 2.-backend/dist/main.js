...
const Usuario_1 = require("./http/rutas/Usuario");
...
class Server {
    ...
    config() {
        ...
        //     console.log(origin)
        //     res.setHeader('Access-Control-Allow-Origin', 'https://www.elgigantedelosazulejos.com.mx');
        ...
        let corsOptions = {
            origin: function (origin, callback) {
                var originIsWhitelisted = self._url_allow_origin.indexOf(origin) !== -1;
    ...
    apiRutas() {
        let rutas = ruteo_1.Ruteador.init([
            ...
            new Usuario_1.UsuarioRouter().rutas(),
