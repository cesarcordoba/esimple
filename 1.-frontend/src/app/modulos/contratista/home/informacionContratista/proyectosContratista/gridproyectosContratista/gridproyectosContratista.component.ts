...
@Component({
  selector: 'gridproyectosContratista',
  templateUrl: './gridproyectosContratista.component.pug',
  styleUrls: ['./gridproyectosContratista.component.styl']
})
export class GridproyectoscontratistaComponent implements OnInit {
